...
$__System.register("4", [], function (_export, _context) {
  return {
    setters: [],
    execute: function () {
      _export("default", "<div ng-controller=\"searchController as searchVm\" class=\"container\">\n    <h1 class=\"searchPageHeader\">Society Education Programs</h1>\n    \n    <div class=\"col-sm-10 col-sm-offset-1\">\n        <div class=\"searchForm\">\n            <div class=\"row\">\n                <select-box\n                    class=\"col-xs-12 col-sm-6\"\n                    place-holder=\"PROGRAM TYPE\" \n                    selected-option=\"{{searchVm.programType}}\"\n                    options=\"searchVm.selectOptions.programTypes\"\n                    change-function=\"searchVm.onProgramTypeChange\"\n                >\n                </select-box>          \n                <select-box\n                    class=\"col-xs-12 col-sm-6\"\n                    place-holder=\"EDUCATION LEVEL\" \n                    selected-option=\"{{searchVm.educationLevel}}\"\n                    options=\"searchVm.selectOptions.educationLevels\"\n                    change-function=\"searchVm.onEducationLevelChange\"\n                >\n                </select-box>\n            </div>\n            <div class=\"row\">\n                <button \n                    ng-click=\"searchVm.processAndSearch()\"\n                    class=\"searchButton xol-xs-6 col-xs-offset-3 col-sm-2 col-sm-offset-5\"\n                >\n                    SEARCH\n                </button>\n            </div>\n        </div>\n    </div>\n    <div class=\"col-sm-10 col-sm-offset-1\">        \n        <div class=\"col-xs-12 col-sm-3 orgImageHolder\" ng-repeat=\"org in searchVm.orgData track by $index\">\n            <img \n                ng-class=\"{'disabled': !org.relevantToSearch}\" \n                ng-src=\"{{searchVm.images.path + org.imagePath + searchVm.images.ext}}\" \n                alt=\"Logo for {{org.imagePath}}\"\n            >\n        </div>\n    </div>\n</div>");
    }
  };
});
...
$__System.registerDynamic("13", ["d", "f", "11", "12"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
$__System.registerDynamic("14", ["b", "13"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
  var $export = $__require('b');
  $export($export.S + $export.F, 'Object', {assign: $__require('13')});
  return module.exports;
});
...
$__System.registerDynamic("15", ["14", "c"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
$__System.register("17", [], function (_export) {
    ...
    return {
        setters: [],
        execute: function () {
            _export("default", throwErrorIfNotArray);
        }
    };
});

$__System.register('18', ['16', '17'], function (_export) {
    var _Object$assign, throwErrorIfNotArray;

    function checkSearchRelevancy(organizations) {
        for (var _len = arguments.length, searchOptions = Array(_len > 1 ? _len - 1 : 0), _key = 1; _key < _len; _key++) {
            searchOptions[_key - 1] = arguments[_key];
        }
        ...
        if (!searchOptions.length) {
            return organizations.map(function (org) {
                return _Object$assign({}, org, { relevantToSearch: false });
            });
        } else {
        ...
        function assignSearchRelevancy(org) {
            ...
            return _Object$assign({}, org, { relevantToSearch: bool });
    ...
    return {
        setters: [function (_) {
            ...
            throwErrorIfNotArray = _2['default'];
        }],
        execute: function () {
            'use strict';

            _export('default', checkSearchRelevancy);
        }
    };
});
...
$__System.register('1a', [], function (_export) {
    ...
    return {
        ...
        execute: function () {
            selectBoxOptions = {
                programTypes: ['SEARCH ALL', 'Scholarship Program', 'Loan Program'],
                educationLevels: ['SEARCH ALL', 'Kindergarten', 'High School']
            };

            _export('default', selectBoxOptions);
        }
    };
});

$__System.register('1b', ['7', '18', '19', '1a'], function (_export) {
    'use strict';

    var organizationData, searchUtil, imageDetails, selectBoxOptions;
    ...
    function searchController() {
        ...
        vm.processAndSearch = function processAndSearch() {
            ...
            vm.orgData = searchUtil.apply(undefined, [organizationData].concat(searchOptions));
        };

        //Functions to pass into the select box directives
        vm.onProgramTypeChange = function (newVal) {
            return vm.programType = newVal;
        };
        vm.onEducationLevelChange = function (newVal) {
            return vm.educationLevel = newVal;
        };
    }

    return {
        setters: [function (_) {
            organizationData = _['default'];
        }, function (_2) {
            searchUtil = _2['default'];
        }, function (_3) {
            imageDetails = _3['default'];
        }, function (_a) {
            selectBoxOptions = _a['default'];
        }],
        execute: function () {
...
$__System.register('1c', [], function (_export) {
    ...
    return {
        setters: [],
        execute: function () {
            selectBoxController = ['$scope', function selectBoxController($scope) {
            ...
            _export('default', selectBoxController);
        }
    };
});
...
$__System.register("1d", [], function (_export, _context) {
  return {
    setters: [],
    execute: function () {
      _export("default", "<div class=\"selectBox_mf_demo\">\n    <div class=\"selectedOption selectedOption-getSize padded noSelect\"\n        ng-click=\"toggleOptions()\"\n    >\n        {{selectedOption ? selectedOption : placeHolder}}\n        <span class=\"icon\">\n            <i class=\"fa fa-chevron-down\" aria-hidden=\"true\"></i>\n        </span>\n    </div>\n    <div ng-show=\"showOptions\" class=\"optionContainer optionContainer-resize\">        \n        <div \n            class=\"option padded noSelect\" \n            ng-repeat=\"option in options track by $index\"\n            ng-click=\"changeFunction(option); toggleOptions()\"\n        >\n            {{option}}\n            <span class=\"icon\" ng-if=\"$first\">\n                <i class=\"fa fa-chevron-up\" aria-hidden=\"true\"></i>\n            </span>\n        </div>\n    </div>\n</div>");
    }
  };
});
(function() {
...
$__System.register('21', ['20', '1c', '1d', '1f'], function (_export) {
    'use strict';

    var controller, template, $, selectBox;
    return {
        ...
        execute: function () {
            selectBox = function selectBox() {
                return {
                    ...
                    link: function link($scope, element, attrs) {
                        ...
                        var targetWidth = selectedOption.outerWidth();
                        var optionsContainer = $('.optionContainer-resize').first();
            ...
            _export('default', selectBox);
        }
    };
});

$__System.register('1', ['3', '6', '21', '1b'], function (_export) {
  'use strict';

  var angular, AppComponent, selectBox, SearchController;
  return {
    setters: [function (_) {
      angular = _['default'];
    }, function (_2) {
      AppComponent = _2['default'];
    }, function (_3) {
      selectBox = _3['default'];
    }, function (_b) {
      SearchController = _b['default'];
    }],
    execute: function () {

      angular.module('myApp', []).directive('mfDemoApp', AppComponent).controller('searchController', SearchController).directive('selectBox', selectBox);
...
$__System.register('src/app.css!github:systemjs/plugin-css@0.1.21.js', [], false, function() {});
$__System.register('src/components/selectBox/selectBox.css!github:systemjs/plugin-css@0.1.21.js', [], false, function() {});
(function(c){if (typeof document == 'undefined') return; var d=document,a='appendChild',i='styleSheet',s=d.createElement('style');s.type='text/css';d.getElementsByTagName('head')[0][a](s);s[i]?s[i].cssText=c:s[a](d.createTextNode(c));})
("@font-face{font-family:greatVibes;src:url(src/fonts/greatVibes/GreatVibes-Regular.otf)}@font-face{font-family:ralewayBold;src:url(src/fonts/raleway/Raleway-Bold.ttf)}*{font-family:ralewayBold}.logoContainer{margin-bottom:50px}.noSelect{-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;-webkit-touch-callout:none;-webkit-user-select:none;user-select:none}.orgImageHolder{height:120px}.orgImageHolder img{display:block;margin-left:auto;margin-right:auto}.orgImageHolder img.disabled{opacity:.2}.searchButton{background:#9d222a;border:none;color:#FFF;font-size:20px;height:40px;margin-top:25px;text-transform:uppercase}.searchForm{background:#EEE;margin-bottom:100px;margin-top:30px;padding:150px 20px 30px}.searchPageHeader{color:#9d222a;font-family:greatVibes;font-size:64px;margin-top:50px;text-align:center;text-shadow:1px 1.73px 0 rgba(255,255,255,.004)}.selectBox_mf_demo .icon{color:#29241b;float:right;padding-right:10px}.selectBox_mf_demo .optionContainer{background:#e3dcdd;color:#430700;position:absolute;text-transform:uppercase;width:100%;z-index:100}.selectBox_mf_demo .option{border-bottom:1px solid rgba(41,36,27,.25);cursor:pointer;padding-left:25px;width:100%}.selectBox_mf_demo .option:hover{background:rgba(0,0,0,.1)}.selectBox_mf_demo .option:last-child{border-bottom:none}.selectBox_mf_demo .padded{padding-top:10px;padding-bottom:10px}.selectBox_mf_demo .selectedOption{background:#FFF;color:#d1d7b9;cursor:pointer;padding-left:10px;text-transform:uppercase;width:100%}");
})
(function(factory) {
  factory();
});